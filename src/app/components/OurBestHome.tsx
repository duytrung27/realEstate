  ...
  return (
    <div>
      <div className="px-10 xl:px-0 xl:max-w-7xl m-auto w-full text-center align-middle pt-20 pb-20 xl:pt-28">
        <RevealOnScroll animate="animate__zoomInDown">
          ...
          <div className="text-[40px] md:text-[60px] xl:text-7xl capitalize mt-6 mb-20">
            <h1>
              Find your
              <span className="text-primary font-semibold"> dream </span>
            </h1>
            <h1>home here</h1>
          </div>
        </RevealOnScroll>
        ...
        <div>
          <RevealOnScroll animate="animate__slideInLeft">
          ...
          <RevealOnScroll animate="animate__slideInRight">
